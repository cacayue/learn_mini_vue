...
function patchProps(el, key, element) {
...
const render = createRender({ createElement, patchProps, insert });
function createApp(...args) {
    return render.createApp(...args);
}

export { createApp, createRender, createTextVNode, getCurrentInstance, h, inject, provide, renderSlot };
